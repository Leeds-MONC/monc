...
module operator_mod
  ...
  abstract interface
     ...
     function perform_activity(io_configuration, field_values, action_attributes)       
       ...
       type(map_type), intent(inout) :: action_attributes
       real(kind=DEFAULT_PRECISION), dimension(:), allocatable :: perform_activity
     end function perform_activity
  end interface

  public perform_activity, initialise_operators, finalise_operators, get_operator_required_fields, get_operator_perform_procedure
contains
