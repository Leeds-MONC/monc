...
module writer_types_mod
  ...
  type writer_field_type
     ...
     integer :: time_manipulation_type, values_mutex, dimensions, field_type, data_type, max_timeseries_points_per_dump, &
          actual_dim_size(4)
     real :: output_frequency, previous_write_time
     logical :: collective_write, pending_to_write
